...
const  AttractionInfo = ({ attraction, handleClose }) => {
    ...
    return (
      ...
      {attraction.recreationalActivities &&
        attraction.recreationalActivities.length > 0 && (
          <Box mt={4}>
            <Heading as="h3" size="md" mb={2}>
              Activities:
            </Heading>
      ...
      {attraction.localCultureAndCustoms &&
        attraction.localCultureAndCustoms.etiquette &&
        attraction.localCultureAndCustoms.etiquette.length > 0 && (
          <Box mt={4}>
            <Heading as="h3" size="md" mb={2}>
              Etiquette:
            </Heading>
            ...
            <Stack spacing={2}>
              {attraction.localCultureAndCustoms.etiquette.map(
                (rule, index) => (
                  <Badge key={index} colorScheme="teal">
                    {rule}
                  </Badge>
      ...
      {attraction.traditionalFestivals &&
        attraction.traditionalFestivals.length > 0 && (
          <Box mt={4}>
            <Heading as="h3" size="md" mb={2}>
      ...
      {attraction.safetyAndSecurity && (
        <Box mt={4}>
          ...
          {attraction.safetyAndSecurity.advice &&
            attraction.safetyAndSecurity.advice.length > 0 && (
              <>
                <Text fontSize="md" color="gray.700">
                  Advice:
                </Text>
          ...
          {attraction.safetyAndSecurity.measures &&
            attraction.safetyAndSecurity.measures.length > 0 && (
              <>
                <Text fontSize="md" color="gray.700">
                  Measures:
                </Text>
                ...
                <Stack spacing={2}>
                  {attraction.safetyAndSecurity.measures.map(
                    (measure, index) => (
                      <Text key={index} fontSize="md" color="gray.700">
                        - {measure}
                      </Text>
      ...
      {attraction.transportation && (
        <Box mt={4}>
          ...
          {attraction.transportation.modes &&
            attraction.transportation.modes.length > 0 && (
